...
def	make_signature():
	...
	access_key = "{bob0Wfsr5s1bkymttsDT}"				# access key id (from portal or Sub Account)
	secret_key = "{Gq9ysPKZduLuIlYefRtVMj7877PgO3SUkHMoEhM2}"				# secret key (from portal or Sub Account)
